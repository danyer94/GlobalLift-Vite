import type { CompanyOverviewCopy, CompanyProfile, CompanyValue } from '../content/siteContent';

type CompanyOverviewProps = {
  profile: CompanyProfile;
  values: CompanyValue[];
  copy: CompanyOverviewCopy;
};

export function CompanyOverview({ profile, values, copy }: CompanyOverviewProps) {
  return (
      ...
      <div className="container mx-auto px-6">
        <div className="grid gap-12 lg:grid-cols-[1.15fr,1fr] lg:items-start">
          ...
          <div className="grid gap-4">
            ...
            <div className="panel-solid p-6">
              <p className="text-xs uppercase tracking-[0.32em] text-muted">{copy.commitmentLabel}</p>
