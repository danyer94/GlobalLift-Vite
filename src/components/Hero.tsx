...
export function Hero({ copy }: HeroProps) {
  ...
  return (
    <section className="hero-aurora hero-showcase min-h-[90vh] pt-28 pb-16 flex items-center justify-center" style={heroBackdropStyle}>
      ...
      <div className="relative z-10 flex w-full">
        <div className="container mx-auto px-6 pb-10 flex flex-col items-center justify-center w-full">
          <div className="grid w-full max-w-6xl gap-10 lg:grid-cols-[1.1fr,0.9fr] lg:items-center">
            ...
            <div className="panel-solid p-6 shadow-lift">
